function approveForm(e) {
  ...
  if (typeof e.txtComment == 'undefined') {
    txtComment = '';
  }
  ...
  if (typeof e.txtRef3_ == 'undefined') {
    urgent_reason = '';
  }
  //return e.txtJudge;
  //-----------------------New
  ...
  var master_form = SpreadsheetApp.openByUrl(DATA_SPREADSHEET)
    .getSheetByName('Master')
    .getDataRange()
    .getValues()
    .filter(function (dataRow) {
      return dataRow[0] === e.txtMaster && dataRow[1] === e.txtCompany;
    });
  ...
  if (search_string != 'admin@ngkntk-asia.com') {
    ...
    if (search_row != null) {
      ...
      // if (txtJudge=='r'){
      if (txtJudge == 'r' || txtJudge == 'c') {
        //ADDED BY WP 20210916 TO REMOVE THE SIGNATURE IF CANCEL ACTION
        do {
...
*/
  ...
  if (text_ref1.length > 120) {
    text_ref1 = text_ref1.substr(0, 120) + '...';
  }
  ////Logger.log(pk)
  //return ;
  //var t6 = new Date();
  ...
  if (txtRt == '1A') {
    ...
    if (txtJudge == 'a') {
      ...
      msg =
        'You have received Application from WorkFlow Launcher.\r\n' +
      ...
      msg =
        'Your master registration request has been rejected\r\n' +
        '＜Comment＞\r\n' +
        txtComment +
        '\r\n＜Application Sheet＞\r\n' +
        txtUrl;
    ...
    if (txtJudge == 'a') {
      ...
      MailApp.sendEmail(
        ml,
        '' + 'WFL <Rejected by Reviewer>  ' + text_ref1 + ':' + pk,
        msg,
        {
          cc: mlcc,
        }
  ...
  if (txtRt == '3') {
    ...
    if (txtJudge == 'a') {
      ...
      mlcc =
        'admin@ngkntk-asia.com,' +
        ss1.getRange('F' + txtId).getValue() +
        ',' +
        ss1.getRange('AU' + txtId).getValue(); //ORIGINAL
      mlcc = mlcc.toString().replace(' ', ''); //ADDED BY WNP 20210707 TO FIX CASE SPACE WITH EMAIL ADDRESS - ERROR INVALID ADDRESS

      //return ml;
      msg =
        'WorkFlow Launcher have been approved. Please perform next process.\r\n' +
      ...
      msg =
        'Your application has been rejected by approver.\r\n\r\n' +
        '＜Comment＞\r\n' +
        txtComment +
        '\r\n\r\n' +
      ...
      MailApp.sendEmail(
        m_s,
        '' + 'WFL <Rejected by Final Approver>' + text_ref1 + ':' + pk,
        msg,
        { cc: mlcc }
      );
    ...
    //////NO NEED TO SEND EMAIL
      ...
      msg =
        'Approver has cancelled the previous action, the document is now pending for Approver.\r\n\r\n' +
        '＜Comment＞\r\n' +
        txtComment +
        '\r\n\r\n' +
        txtUrl; //＜Application Sheet＞\r\n" + doc_url;
      ...
      MailApp.sendEmail(
        m_s,
        '' + 'WFL <Action Cancelled by Final Approver>' + text_ref1 + ':' + pk,
        msg,
        { cc: mlcc }
      );
    }
  ...
  //if (txtRt == "4" || end_rt == 1) {
  if ((txtRt == '4' || end_rt == 1) && txtJudge != 'c') {
    //20211001
    ...
    mlcc =
      ...
      ss1.getRange('F' + txtId).getValue() +
      ',' +
      ss1.getRange('AU' + txtId).getValue();
